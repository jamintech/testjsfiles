 ...
 */
 ...
 /*!
 * Changes By Josh Abbott
 * Date: 2020-01-07
 * 1. Switched from Emojione images to system Emoji fonts
 * 2. Removed flag Emojis, which are not well supported on Windows
 */
...
; ( function ( factory, global ) {
    ...
    function getTemplate(template, unicode, shortname) {
        ...
        if (unicode.includes('-')) {
            var splitunicode = unicode.split('-');
            htmlCode = '';
            for (var index=0; index < splitunicode.length; index++) {
                htmlCode = htmlCode + '&#x' + splitunicode[index] + ';';
            }
        } else {
            htmlCode = '&#x' + unicode + ';';
        }
...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        self.emojiTemplate = '{htmlcode}';
        self.emojiTemplateAlt = '<span style="font-style: normal;" class="emojioneemoji">{htmlcode}</span>';
        ...
        $.each(options.filters, function(filter, params) {
            ...
            do {
                ...
                items = shortnameTo(items,
                        '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><span style="font-style: normal;" class="emojioneemoji lazy-emoji">{htmlcode}</span></i>',
                    true).split('|').join('');
    ...
    $.fn.emojioneAreaText = function(options) {
        ...
        var self = this, pseudoSelf = {
            ...
            emojiTemplate: '<span style="font-style: normal;" class="emojioneemoji">{htmlcode}</span>'
        };
